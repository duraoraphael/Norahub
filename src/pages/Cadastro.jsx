        ...
        <div className="w-full max-w-lg bg-white p-8 rounded-xl shadow-2xl border border-gray-200">
          ...
          <form onSubmit={handleRegisterSubmit}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                 <div className="md:col-span-2"><label className="block text-sm font-medium text-gray-700 text-gray-300">Nome</label><input type="text" value={nome} onChange={e=>setNome(e.target.value)} className="w-full pl-4 py-2 bg-gray-50 bg-gray-700 border border-gray-300 border-gray-600 rounded-md focus:ring-2 focus:ring-[#57B952] placeholder-gray-400 placeholder-gray-500" placeholder="Ex: João Silva" required /></div>
                 <div className="md:col-span-2"><label className="block text-sm font-medium text-gray-700">Nome</label><input type="text" value={nome} onChange={e=>setNome(e.target.value)} className="w-full pl-4 py-2 bg-gray-50 border border-gray-300 rounded-md focus:ring-2 focus:ring-[#57B952] placeholder-gray-400" placeholder="Ex: João Silva" required /></div>
                 <div><label className="block text-sm font-medium text-gray-700 text-gray-300">Email</label><input type="email" value={email} onChange={e=>setEmail(e.target.value)} className="w-full pl-4 py-2 bg-gray-50 bg-gray-700 border border-gray-300 border-gray-600 rounded-md focus:ring-2 focus:ring-[#57B952] placeholder-gray-400 placeholder-gray-500" placeholder="email@exemplo.com" required /></div>
                                 <div><label className="block text-sm font-medium text-gray-700">Email</label><input type="email" value={email} onChange={e=>setEmail(e.target.value)} className="w-full pl-4 py-2 bg-gray-50 border border-gray-300 rounded-md focus:ring-2 focus:ring-[#57B952] placeholder-gray-400" placeholder="email@exemplo.com" required /></div>
                 <div><label className="block text-sm font-medium text-gray-700 text-gray-300">Senha</label><input type="password" value={senha} onChange={e=>setSenha(e.target.value)} className="w-full pl-4 py-2 bg-gray-50 bg-gray-700 border border-gray-300 border-gray-600 rounded-md focus:ring-2 focus:ring-[#57B952] placeholder-gray-400 placeholder-gray-500" placeholder="******" required /></div>
                                 <div><label className="block text-sm font-medium text-gray-700">Senha</label><input type="password" value={senha} onChange={e=>setSenha(e.target.value)} className="w-full pl-4 py-2 bg-gray-50 border border-gray-300 rounded-md focus:ring-2 focus:ring-[#57B952] placeholder-gray-400" placeholder="******" required /></div>
                 <div><label className="block text-sm font-medium text-gray-700 text-gray-300">CPF</label><input type="text" value={cpfMatricula} onChange={e=>setCpfMatricula(e.target.value)} className="w-full pl-4 py-2 bg-gray-50 bg-gray-700 border border-gray-300 border-gray-600 rounded-md focus:ring-2 focus:ring-[#57B952] placeholder-gray-400 placeholder-gray-500" placeholder="000.000.000-00" required /></div>
                                 <div><label className="block text-sm font-medium text-gray-700">CPF</label><input type="text" value={cpfMatricula} onChange={e=>setCpfMatricula(e.target.value)} className="w-full pl-4 py-2 bg-gray-50 border border-gray-300 rounded-md focus:ring-2 focus:ring-[#57B952] placeholder-gray-400" placeholder="000.000.000-00" required /></div>
                 <div><label className="block text-sm font-medium text-gray-700 text-gray-300">Cargo</label><input type="text" value={funcao} onChange={e=>setFuncao(e.target.value)} className="w-full pl-4 py-2 bg-gray-50 bg-gray-700 border border-gray-300 border-gray-600 rounded-md focus:ring-2 focus:ring-[#57B952] placeholder-gray-400 placeholder-gray-500" placeholder="Ex: Analista" required /></div>
                                 <div><label className="block text-sm font-medium text-gray-700">Cargo</label><input type="text" value={funcao} onChange={e=>setFuncao(e.target.value)} className="w-full pl-4 py-2 bg-gray-50 border border-gray-300 rounded-md focus:ring-2 focus:ring-[#57B952] placeholder-gray-400" placeholder="Ex: Analista" required /></div>
                 <div><label className="block text-sm font-medium text-gray-700 text-gray-300">Perfil</label><select value={perfilAcesso} onChange={e=>setPerfilAcesso(e.target.value)} className="w-full pl-4 py-2 bg-white bg-gray-700 text-gray-900 text-white border border-gray-300 border-gray-600 rounded-md focus:ring-2 focus:ring-[#57B952] cursor-pointer" required><option value="" disabled>Selecione...</option><option value="comprador">Comprador</option><option value="solicitante">Solicitante</option></select></div>
