...
function Perfil() {
  ...
  if (loading) return <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-[#111827]"><div className="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-[#57B952]"></div></div>;
  ...
  return (
    <div className="min-h-screen w-full flex flex-col font-[Inter] overflow-x-hidden bg-gray-50 dark:bg-[#111827] transition-colors duration-200 relative">
      ...
      <header className="relative w-full flex items-center justify-between py-6 px-4 md:px-8 bg-white dark:bg-gray-800 shadow-sm border-b border-gray-200 dark:border-gray-700 h-20">
        ...
        <div className="flex items-center gap-3"><span className="text-sm font-medium text-gray-700 dark:text-gray-200 hidden md:block">Olá, {primeiroNome}</span><div className="w-10 h-10 rounded-full overflow-hidden border-2 border-[#57B952] bg-gray-200 dark:bg-gray-700 flex items-center justify-center">{fotoURL ? <img src={fotoURL} className="w-full h-full object-cover" /> : <User size={20} className="text-gray-500 dark:text-gray-400" />}</div></div>
      </header>
      <main className="flex-grow flex flex-col items-center justify-start p-4 md:p-8 relative z-10">
        <div className="w-full max-w-2xl bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden mb-10">
            <div className="h-32 bg-gradient-to-r from-[#57B952] to-green-600 relative"></div>
            <div className="px-8 pb-8">
                <div className="relative -mt-16 mb-6 flex justify-center">
                    <div className="w-32 h-32 rounded-full border-4 border-white dark:border-gray-800 overflow-hidden bg-gray-200 dark:bg-gray-700 flex items-center justify-center shadow-lg group relative">
                ...
                <form onSubmit={handleSave} className="space-y-6">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 pt-6 border-t border-gray-100 dark:border-gray-700">
                        ...
                        <button type="button" onClick={handleLogout} className="flex-1 bg-red-50 dark:bg-red-900/20 hover:bg-red-100 text-red-600 font-bold py-3 px-6 rounded-lg border border-red-100">Sair da Conta</button>
                    </div>
                </form>
            </div>
        </div>
