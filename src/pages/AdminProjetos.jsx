          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {projetos.map((projeto) => (
                <div key={projeto.id} className="bg-white rounded-lg shadow-md border border-gray-200 p-6">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          <div className="bg-white rounded-lg shadow-xl max-w-md w-full p-6 mx-4 max-h-[90vh] overflow-y-auto">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-xl font-bold text-gray-900">Membros: {projetoSelecionado.nome}</h2>
            ...
            <div className="mb-4">
              <label className="block text-sm font-medium text-gray-700 mb-2">Adicionar Usuário</label>
              <div className="flex gap-2">
                <select
                  ...
                  className="flex-1 px-3 py-2 rounded-lg border border-gray-300 bg-white text-gray-900 focus:ring-2 focus:ring-[#57B952] outline-none text-sm"
                >
            ...
            <div className="mb-6">
              <label className="block text-sm font-medium text-gray-700 mb-2">Membros Atuais ({membrosAdicionados.length})</label>
              {membrosAdicionados.length === 0 ? (
                ...
                <div className="space-y-2 bg-gray-50 p-3 rounded-lg max-h-64 overflow-y-auto">
                  {membrosAdicionados.map(userId => (
                    <div key={userId} className="flex items-center justify-between p-2 bg-white rounded border border-gray-200">
                      <span className="text-sm text-gray-900">{getNomeUsuario(userId)}</span>
                      <button
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 py-2 rounded-lg bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Cancelar
              </button>
              <button
