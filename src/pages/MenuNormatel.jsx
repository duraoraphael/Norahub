      ...
      <main className="flex-grow flex flex-col items-center justify-center p-4 md:p-8">
        <div className="w-full max-w-4xl">
            <div className="text-center mb-12">
                <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Menu Principal</h1>
                <p className="text-gray-500 dark:text-gray-400">Selecione seu perfil de acesso.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <a 
                    ...
                    className="group bg-white dark:bg-gray-800 p-10 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 flex flex-col items-center text-center transition-all transform hover:-translate-y-2 cursor-pointer"
                >
                    <div className="bg-green-100 dark:bg-green-900/30 p-6 rounded-full mb-6 group-hover:scale-110 transition-transform text-[#57B952]">
                        <UserCheck size={48} />
                    </div>
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Sou Solicitante</h3>
                    <p className="text-gray-500 dark:text-gray-400 mb-6">Fazer novas solicitações.</p>
                ...
                >
                    ...
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Sou Comprador</h3>
                    <p className="text-gray-500 dark:text-gray-400 mb-6">Painel de aprovação.</p>
                    <span className="text-blue-600 dark:text-blue-400 font-bold flex items-center gap-1">Acessar <ChevronRight size={16} /></span>
                </a>
            </div>
        </div>
      </main>
