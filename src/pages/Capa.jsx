...
function Capa() {
  ...
  // Link do Formulário (Solicitante) - AINDA MANTIDO AQUI CASO PRECISE, MAS O FLUXO VAI MUDAR
  // const LINK_SOLICITANTE = "..."; 
    ...
    <div className="min-h-screen w-full flex flex-col font-[Inter] overflow-x-hidden relative">
      ...
      <main className="flex-grow flex flex-col items-center justify-center p-4 md:p-8">
        ...
        <div className="flex flex-col md:flex-row gap-8 justify-center items-stretch w-full max-w-5xl">
            ...
            {/* Card NORMATEL -> Vai para Seleção de Projeto */}
            <Link 
                to="/selecao-projeto" // MUDANÇA: Vai para a nova página de seleção
            ...
            >
                <div className="bg-[#57B952] h-full rounded-xl p-8 flex flex-col items-center text-center relative z-10">
                    ...
                    <div className="mt-auto flex items-center gap-2 font-bold bg-white/20 px-6 py-3 rounded-full group-hover:bg-white group-hover:text-[#57B952] transition-colors">
                        Selecionar Projeto <ChevronRight size={20} />
                    </div>
                </div>
            </Link>
